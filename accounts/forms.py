...
class clientForm(forms.ModelForm):
	class Meta:
		...
		widgets = {
            ...
            'zip':forms.TextInput(attrs={'class': 'form-control', 'required':True}),
            'state':forms.TextInput(attrs={'class': 'form-control', 'required':True}),
            'phone':forms.TextInput(attrs={'class': 'form-control', 'required':True}),
            'state_of_origin':forms.TextInput(attrs={'class': 'form-control', 'required':True}),
            'lga':forms.TextInput(attrs={'class': 'form-control', 'required':True}),
            'loan_officer':forms.Select(attrs={'class': 'form-control', 'required':True}),
            'gender':forms.Select(attrs={'class': 'form-control', 'required':True}),
            'dob':forms.DateInput(attrs={'class':'form-control','required':True}),
            'marital_status':forms.Select(attrs={'class':'form-control', 'required':True}),
            'picture':forms.FileInput(attrs={'class':'form-control'}),
            'bio':forms.Textarea(attrs={'class':'form-control'}),
            'current_employer':forms.TextInput(attrs={'class':'form-control', 'required':True}),
            'current_salary':forms.TextInput(attrs={'class':'form-control', 'required':True}),
            'job_description':forms.TextInput(attrs={'class':'form-control', 'required':True}),
            'years_in_workplace':forms.TextInput(attrs={'class':'form-control', 'required':True}),
            'state_of_origin':forms.TextInput(attrs={'class':'form-control', 'required':True}),
            'vehicles_owned':forms.TextInput(attrs={'class':'form-control', 'required':True}),
            'years_at_residence':forms.TextInput(attrs={'class':'form-control', 'required':True}),
            'residential_status':forms.Select(attrs={'class':'form-control', 'required':True}),
            'educational_status':forms.Select(attrs={'class':'form-control', 'required':True}),
